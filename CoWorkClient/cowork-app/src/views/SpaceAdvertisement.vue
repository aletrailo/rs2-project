                ...
                <div class="col-sm-6">
                    ...
                    <div class="card-text">
                        <div class="fw-bold mb-2"> <i class="bi bi-geo-alt-fill"></i>
                            ...
                            <input type="text" v-model="ad.address" class="form-control" id="address">
                        </div>
                        <div class="fw-bold mb-2">
                            <label for="inputAddress2" class="form-label">Opis</label>
                            <input type="text" v-model="ad.description" class="form-control" id="inputAddress2">
                        </div>
                        <div class="fw-bold mb-2"> <i class="bi bi-cash"></i>
                            <label for="price" class="form-label">Cena</label>
                            <div style="display: flex;">
                                <input type="text" v-model="ad.pricePerHour" class="form-control" id="price" style="width: 200px;">
                                <div style=" margin-left: 5px;">rsd po satu</div>
                            </div>
                        </div>
                        <div> <button @click="addAd" type="button" class="btn btn-primary" style="float: right;">Dodaj</button></div>
                    </div>
                </div>
